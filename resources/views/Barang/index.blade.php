		...
		<div class="page-breadcumb">
			...
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item"><a href="/gudang/all">Gudang</a></li>
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{$barang->gudang->alamat}}</td>
									<td>
		   <a href="{{route('edit_barang', $barang->id)}}" class="btn btn-success"><i class="fas fa-edit"></i></a>
		   <a href="{{route('hapus_barang', $barang->id)}}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
									</td>
								</tr>
								@endforeach
							</tbody>
